  ...
  "3": [
    {
      ...
      html: "&#19906;",
      nameMan: "Chun",
      nameEng: "Difficulty at the Beginning",
      above: "3",
      below: "6",
      description:
  ...
  "8": [
    {
      ...
      html: "&#19911;",
      nameMan: "Pi",
      nameEng: "Union, Holding Together",
      above: "3",
      below: "5",
      description:
  ...
  "9": [
    {
      ...
      html: "&#19912;",
      nameMan: "Hsiao Ch'u",
      nameEng: "The Taming Power of the Small",
      above: "2",
      below: "1",
      description:
  ...
  "14": [
    {
      ...
      html: "&#19917;",
      nameMan: "Ta Yu",
      nameEng: "Possession in Great Measure",
      above: "7",
      below: "1",
      description:
  ...
  "18": [
    {
      ...
      html: "&#19921;",
      nameMan: "Ku",
      nameEng: "Work on what has been spoiled (Decay)",
      above: "4",
      below: "2",
      description:
  ...
  "19": [
    {
      ...
      judgement:
        "APPROACH has supreme success.\n Perseverance furthers.\n When the eighth month comes,\nthere will be misfortune.\n\nThe hexagram as a whole points to a time of joyous, hopeful progress. Spring is approaching. Joy and forbearance bring high and low nearer together. Success is certain. But we must work with determination and perseverance to make full use of the propitiousness of the time. And onthing more: spring does not last forever. In the eighth month the aspectsare reversed. Then only two strong, light lines are left; these do not advance but are in retreat (see next hexagram). We must take heed of thischange in good time. If we meet evil before it becomes reality-before ithas even begun to stir-we can master it.",
      image:
        "The earth above the lake:\nThe image of APPROACH.\nThus the superior man is inexhaustible\nIn his will to teach,\nAnd without limits\nIn his tolerance and protection of the people.\n\nThe earth borders upon the lake from above. This symbolizes the approachand condescension of the man of higher position to those beneath him.The two parts of the image indicate what his attitude toward these peoplewill be. Just as the lake is inexhaustible in depth, so the sage is inexhaustible in his readiness to teach mankind, and just as the earth is boundlessly wide, sustaining and caring for all creatures on it, so the sage sustainsand cares for all people and excludes no part of humanity.",
      line1Number: "Nine",
      line1:
        "Joint approach.\nPerseverance brings good fortune.\n\nThe good begins to prevail and to find response in influential circles. This in turn is an incentive to men of ability. IT is well to join thisupward trend, but we must not let ourselves be carried away by the currentof the time; we must adhere perseveringly to what is right. This bring good fortune.",
      line2Number: "Nine",
      line2:
  ...
  "20": [
    {
      ...
      line4Number: "Six",
      line4:
        "describes a man who understands the secrets by which a kingdom can be made to flourish. Such a man must be given an authoritative position, in which he can exert influence. He should be, so to speak, a guest-that is, he should be honored and act independently, and should not be used as a tool.",
      line5Number: "",
      line5: "",
      line6Number: "Nine",
      line6:
  ...
  "24": [
    {
      ...
      html: "&#19927;",
      nameMan: "Fu",
      nameEng: " Return (The Turning Point)",
      above: "5",
      below: "6",
      description:
  ...
  "26": [
    {
      ...
      html: "&#19929;",
      nameMan: "Ta Ch'u",
      nameEng: "The Taming Power of the Great",
      above: "4",
      below: "1",
      description:
  ...
  "27": [
    {
      ...
      html: "&#19930;",
      nameMan: "I",
      nameEng: "Corners of the Mouth (Providing Nourishment)",
      above: "4",
      below: "6",
      description:
  ...
  "28": [
    {
      ...
      html: "&#19931;",
      nameMan: "Ta Kuo",
      nameEng: "Preponderance of the Great",
      above: "8",
      below: "2",
      description:
  ...
  "32": [
    {
      ...
      line2Number: "Nine",
      line2:
        "Remorse disappears. The situation is abnormal. A man's force of character is greater than the available material power. Thus he might be afraid of allowing himself to attempt something beyond his strength. However, since it is the time of DURATION, it is possible for him to control his inner strength and so to avoid excess. Cause for remorse then disappears.",
      line3Number: "Nine",
      line3:
  ...
  "34": [
    {
      ...
      html: "&#19937;",
      nameMan: "Ta Chuang",
      nameEng: "The Power of the Great",
      above: "6",
      below: "1",
      description:
  ...
  "36": [
    {
      ...
      html: "&#19939;",
      nameMan: "Ming I",
      nameEng: "Darkening of the light",
      above: "5",
      below: "7",
      description:
  ...
  "43": [
    {
      ...
      html: "&#19946;",
      nameMan: "Kuai",
      nameEng: "Break-through (Resoluteness)",
      above: "8",
      below: "1",
      description:
  ...
  "45": [
    {
      ...
      html: "&#19948;",
      nameMan: "Ts'ui",
      nameEng: "Gathering Together [Massing]",
      above: "8",
      below: "5",
      description:
  ...
  "51": [
    {
      ...
      html: "&#19954;",
      nameMan: "Chên",
      nameEng: "The Arousing (Shock, Thunder)",
      above: "6",
      below: "6",
      description:
  ...
  "52": [
    {
      ...
      html: "&#19955;",
      nameMan: "Kên",
      nameEng: "Keeping Still, Mountain",
      above: "4",
      below: "4",
      description:
  ...
  "53": [
    {
      ...
      html: "&#19956;",
      nameMan: "Chien",
      nameEng: "Development (Gradual Progress)",
      above: "2",
      below: "4",
      description:
  ...
  "57": [
    {
      ...
      html: "&#19960;",
      nameMan: "Sun",
      nameEng: "The Gentle (The Penetrating, Wind)",
      above: "2",
      below: "2",
      description:
  ...
  "59": [
    {
      ...
      html: "&#19962;",
      nameMan: "Huan",
      nameEng: "Dispersion [Dissolution]",
      above: "2",
      below: "3",
      description:
